...
{
  "title": "string — a short, specific topic name (3-6 words) that captures what should be taught, NOT a restatement of the learner's raw input",
  "objectives": [
...
STRICT NOTES FORMAT — the "notes" field must follow this exact markdown structure, no deviations:
...
- multiple_choice options: exactly 4. true_false options: exactly ["True", "False"].
- correctIndex is zero-based and must be valid for the options array.
- IDs should be short unique strings (e.g. "obj-1", "fc-1", "q-1").
